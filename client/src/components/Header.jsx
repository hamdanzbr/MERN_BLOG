    ...
    <div className="navbar bg-gray-600">
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1">
          <li>
            <Link to={'/'} className={`hover:bg-yellow-600 ${pathname === '/' ? 'bg-yellow-600' : ''}`}>
              <b className='text-white'>Home</b>
            </Link>
          </li>
          <li>
            <Link to={'/about'} className={`hover:bg-yellow-600 ${pathname === '/about' ? 'bg-yellow-600' : ''}`}>
              <b className='text-white'>About</b>
            </Link>
          </li>
          <li>
            <Link to={'/projects'} className={`hover:bg-yellow-600 ${pathname === '/projects' ? 'bg-yellow-600' : ''}`}>
